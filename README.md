...
Sou estudante de Ciência da Computação, formado no curso técnico em Informática para Internet.  
Focado em desenvolvimento de software, arquitetura de sistemas e criação de aplicações modernas, escaláveis e bem estruturadas.

Tenho experiência com desenvolvimento front-end moderno, integração com APIs, banco de dados e organização profissional de projetos.
...
- Desenvolvedor Front-End e Software  
- Interesse em engenharia de software e arquitetura  
- Focado em evolução técnica contínua  

---

# Perfil GitHub

https://github.com/felipefigueira18
